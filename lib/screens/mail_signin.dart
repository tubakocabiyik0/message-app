...
class _SigninWithMailState extends State<SigninWithMail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: authProvider.viewState == ViewState.Idle
          ? Container(
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    Padding(
                      padding:
                          const EdgeInsets.only(top: 90.0, right: 8, left: 8),
                      child: Textformfield(
                    ...
                    Padding(
                      padding:
                          const EdgeInsets.only(top: 18.0, right: 40, left: 40),
                      child: ButtonWidgets(
                          buttonText: "Sign in",
                          pressed: () => login(context),
